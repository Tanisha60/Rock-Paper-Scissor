...
Label(text = '', font = font.Font(size = 20), bg = '#FFE873').pack()
...
def player_choice(player_input):
    ...
    if player_input == computer_input:
        winner_label.config(text = "Tie between User and Computer")
...
winner_label = Label(text = "Let's Start the Game.", fg = 'black', bg = 'white', font = font.Font(size = 13), pady = 8)
winner_label.pack()

input_frame = Frame(root, bg = '#FFEBCD')
input_frame.pack()
